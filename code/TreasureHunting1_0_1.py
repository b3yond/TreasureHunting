...
class Character():
    ...
    def print_char(self, name, race, kon, srg, ges, agi, hp, level):
        # print out character
...
'''	def print_char(self, name, race, kon, srg, ges, agi):
		print("----- Spielercharakter -----")
		print("NAME: " + self.name + "   LEVEL: " + str(self.level))
		print("WERTE:")
		print("Leben: " + str(self.hp) + " / " + str(self.kon*8 + self.srg*5 + 10))
		print("Bewegung: " + str(movement(self.agi, self.kon, self.race)))
		print("Nahkampf: " + str(melee_skill(self.srg, self.ges)))
		print("Fernkampf: " + str(gun_skill(self.agi, self.ges)))
		print("ATTRIBUTE: ")
		print("Konstitution: " + str(self.kon))
		print("Stärke: " + str(self.srg))
		print("Geschicklichkeit: " + str(self.ges))
		print("Schnelligkeit: " + str(self.agi))
		print("----------------------------") '''
...
def start_game():  # is called by main_menu-function - base architecture?
    player = char_create()
    player.print_char(player.name, player.race, player.kon, player.srg, player.ges, player.agi, player.hp, player.level)
    main_menu()
